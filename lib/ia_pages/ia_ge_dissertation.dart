// 📁 lib/ia_pages/ia_ge_dissertation.dart
...
class IaGeDissertationScreen extends StatefulWidget {
  final String matiereTitre;

  const IaGeDissertationScreen({
    super.key,
    required this.matiereTitre,
  });

  @override
  State<IaGeDissertationScreen> createState() => _IaGeDissertationScreenState();
}

class _IaGeDissertationScreenState extends State<IaGeDissertationScreen>
  ...
  // Clé du prompt stocké dans Supabase
  static const String _promptKey = 'GE1';
  ...
  static const String _historyType = 'dissertation_geo';
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          'Prof IA vous a offert 10 analyses de sujets de géographie. '
  ...
  Future<void> _submitSubject() async {
    ...
    if (subject.isEmpty) {
      _showElegantSnack(
        'Écris d’abord ton sujet de géographie.',
    ...
    try {
      ...
      final validationError = _validateGeoJson(decoded);
  ...
  // ==========================================================
  // VALIDATION DU JSON (spécifique à la géographie)
  // ==========================================================

  String? _validateGeoJson(Map<String, dynamic> json) {
    ...
    for (final part in parties) {
      ...
      for (final arg in args) {
        ...
        if (!arg.containsKey('idee') || !arg.containsKey('explication')) {
          return 'Chaque argument doit avoir une idée et une explication.';
        }
      }
    }

    final intro = json['introduction'];
    if (intro is! Map || !intro.containsKey('problematique')) {
      return 'Introduction ou problématique manquante.';
    }
    ...
    if (controle['espace_respecte'] != true) {
      return "L'espace étudié doit être respecté.";
    }
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Prof IA est spécialisé en dissertation de géographie. Envoie un sujet de géographie pour obtenir un plan détaillé.',
                      style: TextStyle(
                        color: texteSecondaire,
                        fontSize: 11.5,
                        height: 1.4,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  'Prof IA analyse ton sujet géographique et construit un plan adapté avec des exemples concrets.',
                  style: TextStyle(
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    hintText:
                        'Exemple :\n« Le tourisme en Côte d\'Ivoire : atouts et perspectives. »',
                    hintStyle: TextStyle(
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Analyse du sujet • construction du plan • exemples géographiques',
                    style: TextStyle(
                      fontSize: 10.5,
                      height: 1.35,
                      color: texteSecondaire,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _errorMessage ??
                  'Désolé, je suis là pour t’aider à travailler ta dissertation de géographie.',
              style: const TextStyle(
                color: texte,
                fontSize: 14,
                height: 1.5,
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Envoie un sujet de dissertation de géographie pour commencer.',
                      style: TextStyle(
                        color: texteSecondaire,
                        fontSize: 11.5,
                        height: 1.4,
  ...
  // ==========================================================
  // RESULTAT PRINCIPAL (adapté à la géographie)
  // ==========================================================
    ...
    return _sectionContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _miniLabel('Espace concerné'),
          const SizedBox(height: 7),
          _textBlock(analyse['espace']),
          const SizedBox(height: 16),
          if (analyse['limites_spatiales'] != null &&
              analyse['limites_spatiales'].toString().isNotEmpty) ...[
            _miniLabel('Limites spatiales'),
            const SizedBox(height: 7),
            _textBlock(analyse['limites_spatiales']),
            const SizedBox(height: 16),
          ],
          if (analyse['limites_temporelles'] != null &&
              analyse['limites_temporelles'].toString().isNotEmpty) ...[
            _miniLabel('Limites temporelles'),
            const SizedBox(height: 7),
            _textBlock(analyse['limites_temporelles']),
            const SizedBox(height: 16),
          ],
          ...
          Container(
            ...
            child: Text(
              analyse['problematique']?.toString() ?? '',
              style: const TextStyle(
                color: texte,
                fontSize: 14,
                fontWeight: FontWeight.w700,
  ...
  Widget _buildIntroduction(Map<String, dynamic> result) {
    ...
    return _sectionContainer(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _miniLabel('Localisation'),
          const SizedBox(height: 5),
          _textBlock(intro['localisation']),
          const SizedBox(height: 12),
          _miniLabel('Accroche'),
          const SizedBox(height: 5),
          _textBlock(intro['accroche']),
          const SizedBox(height: 12),
  ...
  // ==========================================================
  // PLAN (spécifique à la géographie)
  // ==========================================================
  ...
  Widget _buildPlan(Map<String, dynamic> result) {
    ...
    final nbParties = plan['nombre_parties'] ?? 2;
    ...
    return _sectionContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          _textBlock(typePlan),
          const SizedBox(height: 12),
          _miniLabel('Nombre de parties'),
          const SizedBox(height: 5),
          _textBlock('$nbParties partie(s)'),
          const SizedBox(height: 16),
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'À toi maintenant de transformer ce plan en dissertation. Prof IA te donne la direction, mais c’est toi qui construis ton analyse.',
                    style: TextStyle(
                      color: texteSecondaire,
                      fontSize: 11.5,
                      height: 1.45,
