// 📁 lib/ia_pages/ia_ph_dissertation.dart
...
class IaPhDissertationScreen extends StatefulWidget {
  final String matiereTitre;

  const IaPhDissertationScreen({
    super.key,
    required this.matiereTitre,
  });

  @override
  State<IaPhDissertationScreen> createState() => _IaPhDissertationScreenState();
}

class _IaPhDissertationScreenState extends State<IaPhDissertationScreen>
  ...
  static const String _promptKey = 'PH1';
  ...
  static const String _historyType = 'dissertation_philo';
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          'Prof IA vous a offert 10 analyses de sujets de philosophie. '
  ...
  Future<void> _submitSubject() async {
    ...
    if (subject.isEmpty) {
      _showElegantSnack(
        'Écris d’abord ton sujet de philosophie.',
  ...
  // ==========================================================
  // VALIDATION DU JSON (spécifique à la philosophie)
  // ==========================================================
  ...
  String? _validatePhiloJson(Map<String, dynamic> json) {
    ...
    final args1 = part1['arguments'];
    final args2 = part2['arguments'];
    if (args1 is! List || args1.length != 3) {
      return 'La partie I doit contenir exactement 3 arguments.';
    }
    if (args2 is! List || args2.length != 3) {
    ...
    if (controle is! Map || controle['nombre_questions_problematique'] != 1) {
      return 'La problématique doit contenir une seule question.';
    }
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Prof IA est spécialisé en dissertation philosophique. '
                      'Envoie un sujet de philosophie pour obtenir un plan détaillé avec des références.',
                      style: TextStyle(
                        color: texteSecondaire,
                        fontSize: 11.5,
                        height: 1.4,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  'Prof IA analyse ton sujet philosophique et construit un plan détaillé avec les références essentielles.',
                  style: TextStyle(
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    _heroBadge(Icons.menu_book_rounded, 'RÉFÉRENCES'),
                    const SizedBox(width: 8),
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Analyse du sujet • construction des arguments • sélection des références',
                    style: TextStyle(
                      fontSize: 10.5,
                      height: 1.35,
                      color: texteSecondaire,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _errorMessage ??
                  'Désolé, je suis là pour t’aider à travailler ta dissertation philosophique.',
              style: const TextStyle(
                color: texte,
                fontSize: 14,
                height: 1.5,
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Envoie un sujet de dissertation philosophique pour commencer.',
                      style: TextStyle(
                        color: texteSecondaire,
                        fontSize: 11.5,
                        height: 1.4,
  ...
  // ==========================================================
  // RÉSULTAT PRINCIPAL (inchangé – spécifique à la philosophie)
  // ==========================================================
  ...
  Widget _buildAnalyse(Map<String, dynamic> result) {
    ...
    final definitions = (analyse['notions_principales'] as List?) ?? [];
    ...
    return _sectionContainer(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _miniLabel('Notions principales'),
          const SizedBox(height: 9),
          ...definitions.map(
            (item) {
          ...
          _textBlock(analyse['reformulation']),
          const SizedBox(height: 16),
          _miniLabel('Problème philosophique'),
          const SizedBox(height: 7),
          _textBlock(analyse['probleme_philosophique']),
          const SizedBox(height: 16),
          _miniLabel('Enjeux'),
          const SizedBox(height: 7),
  ...
  Widget _buildIntroduction(Map<String, dynamic> result) {
    ...
    return _sectionContainer(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _miniLabel('Définition de la notion'),
          const SizedBox(height: 5),
          _textBlock(intro['definition_notion']),
          const SizedBox(height: 12),
          _miniLabel('Constat'),
          const SizedBox(height: 5),
          _textBlock(intro['constat']),
          const SizedBox(height: 12),
          ...
          const SizedBox(height: 12),
          _miniLabel('Annonce des axes'),
          const SizedBox(height: 5),
          _textBlock(intro['annonce_axes']),
        ],
      ),
    );
  }
    ...
    return _sectionContainer(
      ...
      child: Column(
        children: [
          ...
          _axisConnector(
            text: 'Mais peut-on en rester là ?',
          ),
          const SizedBox(height: 11),
          _axisCard(
            number: 'II',
            title: 'ANTITHÈSE / DÉPASSEMENT',
  ...
  Widget _axisConnector({required String text}) {
    return Row(
      children: [
  ...
  Widget _buildDevelopment(Map<String, dynamic> result) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildTransition(transition),
        const SizedBox(height: 14),
        _buildPart(
          number: 'II',
          title: part2['titre']?.toString() ?? 'Antithèse / Dépassement',
          type: 'ANTITHÈSE / DÉPASSEMENT',
          arguments: args2,
          color: vert,
        ),
        const SizedBox(height: 14),
        _buildTransitionFinale(
            development['transition_finale']?.toString() ?? ''),
      ],
    );
  }
  ...
  Widget _argumentCard({
    ...
    final data = Map<String, dynamic>.from(argument as Map);
    final ref = Map<String, dynamic>.from(data['reference'] ?? {});
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 3),
                Text(
                  ref['oeuvre_ou_concept']?.toString() ?? '',
                  style: TextStyle(
                    color: color,
                    fontSize: 12.5,
                    fontWeight: FontWeight.w700,
                ...
                const SizedBox(height: 7),
                Text(
                  ref['idee_philosophique']?.toString() ?? '',
                  style: const TextStyle(
                    color: texteSecondaire,
                    fontSize: 11.5,
                    height: 1.45,
            ...
            child: Column(
              ...
              children: [
                ...
                _transitionLine(
                  ...
                  transition['bilan_partie_1']?.toString() ?? '',
                ),
                const SizedBox(height: 9),
                _transitionLine(
                  'Limite',
                  transition['limite']?.toString() ?? '',
                ),
                const SizedBox(height: 9),
                _transitionLine(
                  'Orientation vers la partie II',
                  transition['orientation_partie_2']?.toString() ?? '',
                ),
              ],
            ),
          ),
  ...
  Widget _buildTransitionFinale(String text) {
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(18),
      decoration: BoxDecoration(
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'À toi maintenant de transformer ce plan en dissertation. Prof IA te donne la direction, mais c’est toi qui construis ta réflexion.',
                    style: TextStyle(
                      color: texteSecondaire,
                      fontSize: 11.5,
                      height: 1.45,
